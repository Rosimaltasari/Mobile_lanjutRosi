...
try {
    switch ($method) {
        ...
        case 'POST':
            ...
            if ($data && !empty($data['judul']) && !empty($data['pengarang']) && !empty($data['penerbit']) && !empty($data['tahun_terbit'])) {
                ...
                echo json_encode(["message" => "Invalid data. Please provide judul, pengarang, penerbit, and tahun_terbit"]);
            }
            break;
